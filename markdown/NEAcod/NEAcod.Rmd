...
The external variance estimates used in this case study are smoothed versions of the external variances estimates. The smooting is perfomed with the following procedure: Let $\mu_{a,y}$ be the observation for age $a$ at year $y$ on natural scale, and let $v_{a,y}$ be the correspondning variance. We assume that
\begin{align}
...
Compare the assessment with usage of the external variances and with use of the internal mean-variance-link.
